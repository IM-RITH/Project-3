                    ...
                    <div class="item d-flex justify-content-start">
                        ...
                        <div class="text">
                            ...
                            <div class="special d-flex justify-content-start">
                                ...
                                @elseif ($job_single->is_featured == 0)
                                    <div class="featured">
                                        Not Featured
                                    </div>
                                @endif
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-12">
                    ...
                    @if (!Auth::guard('company')->check())
                        @if (date('Y-m-') <= $job_single->deadline)
                        <div class="left-item">
                            <div class="apply">
                                <a href="{{ route('candidate_apply', $job_single->id) }}" class="btn btn-primary">Apply Now</a>
                            </div>
                ...
                <div class="col-lg-4 col-md-12">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    <tr>
                                        ...
                                        <td>
                                            {{ $job_single->created_at->format('d-F-Y') }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><b>Deadline:</b></td>
                                        <td>
                                            @php
                                                $date = DateTime::createFromFormat('Y-m-d', $job_single->deadline);
                                            @endphp
                                            {{ $date->format('d-F-Y') }}
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{ $job_single->rJobExperience->name }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><b>Type:</b></td>
                    ...
                    {{-- <div class="right-item">
                        ...
                        <div class="enquery-form">
                            <form action="{{ route('job_enquery_form') }}" method="post">
                                @csrf
