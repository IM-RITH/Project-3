...
@section('seo_title')
    {{ $page_other_item->login_page_title }}
@endsection
@section('seo_meta_description')
    {{ $page_other_item->login_page_meta_description }}
@endsection

@section('main_content')
    <div class="page-top" style="background-image: url('{{ asset('uploads/login.jpg') }}')">
        <div class="bg"></div>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2>{{ $page_other_item->login_page_heading }}</h2>
                </div>
            </div>
        </div>
    </div>
